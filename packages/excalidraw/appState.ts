...
>(config: { [K in keyof T]: K extends keyof AppState ? T[K] : never }) =>
  ...
  exportIncludeGameEffects: { browser: false, export: false, server: false },
  ...
  luminaEnabled: { browser: true, export: true, server: false },
  luminaAmbient: { browser: false, export: true, server: false },
  luminaCaustics: { browser: false, export: true, server: false },
  luminaGameMode: { browser: false, export: false, server: false },
